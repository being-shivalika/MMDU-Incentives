...
const mockHistory = [
  {
    ...
    date: "14 Jul 2024",
    status: "Approved",
    remarks: "Excellent work. Forwarded to RPC.",
  },
  {
    id: "REV-2024",
    ...
    date: "10 Jul 2024",
    status: "Rejected",
    remarks: "Missing documentation for indexing. Needs revision.",
  },
  {
    id: "REV-2025",
    ...
    date: "05 Jul 2024",
    status: "Approved",
    remarks: "Verified project proposal. Sent to Director.",
  },
];
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Log of all approved and rejected department submissions."
        icon={History}
      />
        ...
        <div className="p-4 border-b border-gray-100 flex flex-col sm:flex-row gap-4 justify-between items-center bg-gray-50/50">
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              value={searchTerm}
              onChange={(e) => archTerm(e.target.value)}
            />
          </div>
              ...
              {filteredHistory.length > 0 ? (
                filteredHistory.map((item) => (
                  ...
                  >
                    ...
                    <td
                      className="p-4 max-w-50 truncate text-xs"
                      title={item.remarks}
                    >
                      {item.remarks}
                    </td>
