...
const DepartmentReviewHistory = () => {
  ...
  const loadSubmissions = useCallback(async () => {
    ...
    try {
      ...
      console.error("Failed to load department review history:", err);
      setError(err.message || "Failed to load department review history.");
    } finally {
      setLoading(false);
    }
  }, []);
  ...
  const filteredHistory = submissions.filter((item) => {
    ...
    if (selectedStatus !== "All") {
      if (selectedStatus === "APPROVED") matchesStatus = itemStatus.includes("APPROVED") || itemStatus.includes("COMPLETED") || itemStatus.includes("RPC");
  ...
  const handleExportCSV = () => {
    exportToCSV(
      filteredHistory,
      `MMDU_Department_Review_History_FY2026.csv`
    );
  };
  ...
  const handleExportPDF = () => {
    exportToPDF(
      filteredHistory,
      `MMDU_Department_Review_History_Statement`,
      {
  ...
  return (
    <div className="space-y-6 text-left max-w-7xl mx-auto p-2 sm:p-4">
      <PageHeader
        ...
        subtitle="Log of all reviewed, approved, and rejected department research submissions."
        icon={History}
      />
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-between items-stretch sm:items-center">
          ...
          <div className="flex items-center gap-2 flex-wrap justify-end">
            ...
            <button
              ...
              title="Download CSV report of department review history"
            >
            ...
            <button
              ...
              title="Download PDF statement of department review history"
            >
              ...
              {loading ? (
                ...
                <tr>
                  <td colSpan={7} className="p-8 text-center text-neutral-400">
                    No review history records match your search criteria.
                  </td>
                </tr>
              ) : (
...
export default DepartmentReviewHistory;
