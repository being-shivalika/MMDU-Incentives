  ...
  useEffect(() => {
    const loadDashboardData = async () => {
      ...
      try {
        ...
        console.error("Error loading registrar dashboard:", err);
    ...
    <div className="space-y-6 text-left">
      <div className="bg-white rounded-xl p-6 border shadow-sm">
        <h1 className="text-2xl font-bold text-gray-900">
          Welcome Registrar, {user?.name || "Dr. Williams"}
        </h1>
        <p className="text-gray-500 mt-1">Manage academic records, verify documents, and oversee registration processes.</p>
      </div>
