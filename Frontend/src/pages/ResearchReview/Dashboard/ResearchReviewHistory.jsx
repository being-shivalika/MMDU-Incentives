...
const ResearchReviewHistory = () => {
  ...
  const loadSubmissions = useCallback(async () => {
    ...
    try {
      ...
      console.error("Failed to load RPC review history:", err);
  ...
  const filteredHistory = submissions.filter((item) => {
    ...
    if (selectedStatus !== "All") {
      if (selectedStatus === "VERIFIED") matchesStatus = itemStatus.includes("VERIFIED") || itemStatus.includes("APPROVED") || itemStatus.includes("COMPLETED");
  ...
  const handleExportCSV = () => {
    exportToCSV(
      filteredHistory,
      `MMDU_RPC_Verification_History_FY2026.csv`
    );
  };
  ...
  const handleExportPDF = () => {
    exportToPDF(
      filteredHistory,
      `MMDU_RPC_Verification_History_Statement`,
      {
  ...
  return (
    <div className="space-y-6 text-left max-w-7xl mx-auto p-2 sm:p-4">
      <PageHeader
        ...
        subtitle="Log of all verified, approved, and returned research submissions by RPC / R&D."
        icon={History}
      />
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-between items-stretch sm:items-center">
          ...
          <div className="flex items-center gap-2 flex-wrap justify-end">
            ...
            <button
              ...
              title="Download CSV report of verification history"
            >
            ...
            <button
              ...
              title="Download PDF statement of verification history"
            >
            ...
            <button
              ...
              title="Refresh verification history"
            >
              ...
              {loading ? (
                ...
                <tr>
                  <td colSpan={7} className="p-8 text-center text-neutral-400">
                    No verification history records match your search criteria.
                  </td>
                </tr>
              ) : (
                    ...
                    <tr key={id} className="hover:bg-neutral-50/60 transition-colors">
                      ...
                      <td className="p-4">
                        <span className={`inline-flex items-center px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider border ${
                          String(item.status).includes("Approved") || String(item.status).includes("Verified") || String(item.status).includes("Completed") ? "bg-emerald-50 text-emerald-800 border-emerald-200" :
                      ...
                      <td className="p-4 text-right whitespace-nowrap">
                        <button
                          ...
                          title="View full record details & verification timeline"
                        >
