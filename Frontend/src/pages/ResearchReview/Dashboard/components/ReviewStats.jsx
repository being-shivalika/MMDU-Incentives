    ...
    <div className="space-y-6">
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {statItems.map((stat, idx) => (
          <Card
            key={idx}
            className={`p-4 border ${stat.border} shadow-sm hover:shadow transition-shadow flex flex-col items-center text-center`}
          >
        ...
        <div className="flex items-center gap-4 mb-4 sm:mb-0">
          ...
          <div>
            <p className="text-sm font-semibold text-green-800 uppercase tracking-wide">
              Total Incentive Value Recommended
            </p>
            <p className="text-gray-500 text-sm">
              Accumulated across all submissions ready for accounts.
            </p>
          </div>
        </div>
