...
const PrincipalApprovals = () => {
  ...
  const loadSubmissions = useCallback(async () => {
    ...
    try {
      ...
      // Filter claims in review stage
      setSubmissions(data);
    } catch (err) {
      console.error("Failed to load approvals for Principal:", err);
  ...
  const handleExportCSV = () => {
    exportToCSV(
      filteredData,
      `MMDU_Principal_Approvals_Queue_FY2026.csv`
    );
  };
  ...
  const handleExportPDF = () => {
    exportToPDF(
      filteredData,
      `MMDU_Principal_Approvals_Queue_Statement`,
      {
  ...
  return (
    <div className="space-y-6 text-left max-w-7xl mx-auto p-2 sm:p-4">
      <PageHeader
        ...
        subtitle="Review and process final department research submissions before forwarding."
        icon={CheckCircle}
      />
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-between items-stretch sm:items-center">
          ...
          <div className="flex items-center gap-2 flex-wrap justify-end">
            ...
            <button
              ...
              title="Download CSV report of pending approvals"
            >
            ...
            <button
              ...
              title="Download PDF statement of pending approvals"
            >
              ...
              {loading ? (
                ...
                <tr>
                  <td colSpan={7} className="p-8 text-center text-neutral-400">
                    No pending approval records match your search criteria.
                  </td>
                </tr>
              ) : (
