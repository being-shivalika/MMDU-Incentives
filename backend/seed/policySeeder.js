...
const policyRules = [
  ...
  { category: 'research_publications', subtype: 'journal', condition: 'Q1_SCI_SCIE', conditionLabel: 'Q1 Journal (SCI/SCIE Indexed)', applicantType: 'both', incentiveAmount: 25000, currency: 'INR', scorePoints: 30, maxClaimsPerYear: 10, maxAmountPerYear: 200000, multiAuthorRule: 'divide_equally', description: 'Q1 quartile journal paper indexed in SCI/SCIE' },
  { category: 'research_publications', subtype: 'journal', condition: 'Q2_SCI_SCIE', conditionLabel: 'Q2 Journal (SCI/SCIE Indexed)', applicantType: 'both', incentiveAmount: 20000, currency: 'INR', scorePoints: 20, maxClaimsPerYear: 10, maxAmountPerYear: 200000, multiAuthorRule: 'divide_equally', description: 'Q2 quartile journal paper indexed in SCI/SCIE' },
  { category: 'research_publications', subtype: 'journal', condition: 'Q3_Q4_SCI_SCIE', conditionLabel: 'Q3/Q4 Journal (SCI/SCIE Indexed)', applicantType: 'both', incentiveAmount: 10000, currency: 'INR', scorePoints: 10, multiAuthorRule: 'divide_equally', description: 'Q3 or Q4 quartile journal paper indexed in SCI/SCIE' },
  ...
  { category: 'research_publications', subtype: 'conference', condition: 'IEEE_ACM_SCOPUS', conditionLabel: 'IEEE/ACM/Scopus-Indexed Conference', applicantType: 'both', incentiveAmount: 8000, currency: 'INR', scorePoints: 15, multiAuthorRule: 'divide_equally', description: 'IEEE, ACM, or Scopus indexed conference' },
